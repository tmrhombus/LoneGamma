...
#  "Wen"       \
 ...
 do
  ...
  sed -i "s@ISELE@${isEle}@g"               "${submitbase}/gitignore/${version}/submit/${submitname}_callpostAnalyzer_ZnunuG.cc"
  sed -i "s@ISJET@${isJet}@g"               "${submitbase}/gitignore/${version}/submit/${submitname}_callpostAnalyzer_ZnunuG.cc"
