#define postAnalyzer_Base_cxx
#include "postAnalyzer_Base.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void postAnalyzer_Base::Loop(TString outfilename, Bool_t isMC, Double_t lumi, Double_t nrEvents, Double_t crossSec,
...
/////////////////////////////////////////////////////////////////////
 ...
 std::cout<<"Done"<<std::endl;
  ...
  ///
  ///////-------------------------makeGenDilep
  /////void postAnalyzer_Base::makeGenDilep(int pho_index, std::vector<int> elelist, std::vector<int> mulist, TLorentzVector *fv_1, TLorentzVector *fv_2, TLorentzVector *fv_ee, TLorentzVector *fv_mm)
  /////{
  /////
  ...
  ///
  /////-------------------------makeDilep
  ///void postAnalyzer_Base::makeDilep(int pho_index, TLorentzVector *fv_1, TLorentzVector *fv_2, TLorentzVector *fv_ee, TLorentzVector *fv_mm)
  ///{
  ///  
  ...
  ///
  ///////-------------------------OverlapWithMuon
  /////bool postAnalyzer_Base::OverlapWithMuon(double eta, double phi){
  /////
  /////  bool overlap = false;
  ...
  /////
  ///////-------------------------OverlapWithElectron
  /////bool postAnalyzer_Base::OverlapWithElectron(double eta, double phi){
  /////  bool overlap = false;
  /////
  /////  bool pass_SigmaIEtaIEtaFull5x5 = false;
  /////  bool pass_dEtaIn = false;
