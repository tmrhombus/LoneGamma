#define analyzePDFscaleSignal_cxx
#include "analyzePDFscaleSignal.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void analyzePDFscaleSignal::Loop(TString outfilename, Bool_t isMC, Double_t lumi, Double_t nrEvents, Double_t crossSec,
