...
#ifndef postAnalyzer_WlnG_h
#define postAnalyzer_WlnG_h
...
public :
   ...
   TLorentzVector fourVec_leptomet_e;
   TLorentzVector fourVec_leptomet_m;
   Double_t dilep_mass;

   Double_t leptoMET_e;
   Double_t leptoMEPhi_e;
   Double_t leptoMET_m;
   Double_t leptoMEPhi_m;
  ...
  int nrec_m170;
   ...
   postAnalyzer_WlnG(TTree *tree=0);
   virtual ~postAnalyzer_WlnG();
   ...
   Bool_t           FillSigHistograms(int ptbin, int selbin, int photonIndex, double weight, bool passE, bool passM);
   //Bool_t           FillGenHistograms(int ptbin, int selbin, int photonIndex, double weight); //
   virtual void     callFillSigHist(int selbin, int lastptbin, int inclptbin, int candphotonindex, float event_weight, bool passE, bool passM);
...
#ifdef postAnalyzer_WlnG_cxx
postAnalyzer_WlnG::postAnalyzer_WlnG(TTree *tree) : fChain(0) 
{
}

postAnalyzer_WlnG::~postAnalyzer_WlnG()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t postAnalyzer_WlnG::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t postAnalyzer_WlnG::LoadTree(Long64_t entry)
{
...
void postAnalyzer_WlnG::Init(TTree *tree, Bool_t isMC)
{
   ...
   selbinnames.push_back("_m170_e"); 
   selbinnames.push_back("_m170_m"); 
...
Bool_t postAnalyzer_WlnG::Notify()
{
...
void postAnalyzer_WlnG::Show(Long64_t entry)
{
...
Int_t postAnalyzer_WlnG::Cut(Long64_t entry)
{
...
//Bool_t postAnalyzer_WlnG::FillGenHistograms(int ptbin, int selbin, int photonIndex, double weight){
// weight = 1;
...
Bool_t postAnalyzer_WlnG::FillSigHistograms(int ptbin, int selbin, int photonIndex, double weight, bool passE, bool passM){
 ...
 if(passM){
  ...
  h_mu_leptoMET[ptbin][selbin].Fill( leptoMET_m, weight );
 }
 if(passE){
  ...
  h_ele_leptoMET[ptbin][selbin].Fill( leptoMET_e, weight );
 }
...
Bool_t postAnalyzer_WlnG::WriteHistograms(int ptbin, int selbin){
...
#endif // #ifdef postAnalyzer_WlnG_cxx
