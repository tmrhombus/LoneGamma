...
void plotfrerrors::Loop()
{
 ...
 wwwpath = TString("/afs/hep.wisc.edu/user/tperry/www/MonoPhoton/qcdPlots/"+Tversion);
  ...
  // 2016 (5.6/fb) numbers
  Double_t p_00[4]={0.054045, 0.0358435, 0.0351736, 0.0255505}; 
  Double_t p_01[4]={0.0557957, 0.0370422, 0.0356347, 0.0292993}; 
  Double_t p_02[4]={0.0521562, 0.0354057, 0.0343641, 0.025128}; 
  Double_t p_03[4]={0.0537493, 0.0353898, 0.0332877, 0.0230911}; 
  Double_t p_04[4]={0.0646599, 0.0329457, 0.0323777, 0.0227223}; 
  Double_t p_05[4]={0.0560676, 0.0359456, 0.0351413, 0.0255955}; 
  Double_t p_06[4]={0.0495424, 0.0336941, 0.0329045, 0.024039}; 
  Double_t p_07[4]={0.0676796, 0.0445867, 0.0438302, 0.0311744}; 
  Double_t p_09[4]={0.0565463, 0.0369375, 0.0362786, 0.02801}; 
  Double_t p_10[4]={0.0515437, 0.0347495, 0.0340685, 0.0230911};
  Double_t p_11[4]={0.0552262, 0.0396169, 0.0358343, 0.0215395}; 
