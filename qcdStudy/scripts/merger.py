...
infilename =  "analyzed_GJets_Merged" # "analyzed_SinglePhoton_2015D" # "analyzed_GJets_Merged"  #"mrg4bins_QCD"  # 
outfilename = "mrg4bins_GJets"  #  "mrg4bins_GJets"  #  "mrg3bins_DataSP2015D"  #                 "mrg3bins_QCD"  # 
...
log = open('%s.log'%(outfilename),'w')
log.write('\n\n') 
log.write('  infilename %s \n'%( infilename ) ) 
log.write('\n') 

outfile=gROOT.FindObject(outfilename+'.root')
if outfile : outFile.Close()
outfile = TFile(outfilename+'.root','RECREATE','QCD from mT<30')
