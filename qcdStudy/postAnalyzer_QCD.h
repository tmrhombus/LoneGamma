...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/hdfs/store/user/gomber/SinglePhoton_2015D_1p2fb1_condor/run_data_2015D_74X-005D4D5A-9871-E511-9942-02163E014303.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/hdfs/store/user/gomber/SinglePhoton_2015D_1p2fb1_condor/run_data_2015D_74X-005D4D5A-9871-E511-9942-02163E014303.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/hdfs/store/user/gomber/SinglePhoton_2015D_1p2fb1_condor/run_data_2015D_74X-005D4D5A-9871-E511-9942-02163E014303.root:/ggNtuplizer");
...
void postAnalyzer_QCD::Init(TTree *tree, Bool_t isMC)
{
   ...
   for(unsigned int i=0; i<ptbinnames.size(); ++i){
    ...
    TString histname_bkg_et  = "h_bkg_et_"+ptbinnames[i];
    TString histname_bkg_eta = "h_bkg_eta_"+ptbinnames[i];
    TString histname_bkg_sieieF5x5 = "h_bkg_sieieF5x5_"+ptbinnames[i];
    TString histname_bkg_pfMET = "h_bkg_pfMET_"+ptbinnames[i];

    TString histname_den_et  = "h_den_et_"+ptbinnames[i];
    TString histname_den_eta = "h_den_eta_"+ptbinnames[i];
    TString histname_den_sieieF5x5 = "h_den_sieieF5x5_"+ptbinnames[i];
    TString histname_den_pfMET = "h_den_pfMET_"+ptbinnames[i];
