...
public :
   ...
   TH1F h_sig_et[7][0], h_sig_eta[7][0], h_sig_sieieF5x5[7][0], h_sig_pfMET[7][0];
...
void postAnalyzer_znunug::Init(TTree *tree, Bool_t isMC)
{
   ...
   for(unsigned int i=0; i<ptbinnames.size(); ++i){
    for(unsigned int j=0; j<sysbinnames.size(); ++j){
     ...
     TString histname_sig_dimu_mass = "h_sig_dimu_mass_"+ptbinnames[i]+sysbinnames[j];
     TString histname_sig_diele_mass = "h_sig_diele_mass_"+ptbinnames[i]+sysbinnames[j];
     ...
     h_sig_dilep_mass[i][j] = TH1F(histname_sig_dilep_mass,"PF MET + dilepton",30,60.,120.);
     h_sig_dilep_mass[i][j].Sumw2();
     //
     h_sig_dimu_mass[i][j].Clear();
     h_sig_dimu_mass[i][j] = TH1F(histname_sig_dimu_mass,"PF MET + dimuon",30,60.,120.);
     h_sig_dimu_mass[i][j].Sumw2();
     //
     h_sig_diele_mass[i][j].Clear();
     h_sig_diele_mass[i][j] = TH1F(histname_sig_diele_mass,"PF MET + diele",30,60.,120.);
...
Bool_t postAnalyzer_znunug::FillSigHistograms(int ptbin, int sysbin, int photonIndex, double weight){
 ...
 h_sig_leptoMET[ptbin][sysbin].Fill( leptoMET, weight );
 h_sig_dilep_mass[ptbin][sysbin].Fill( dilep_mass, weight );
 h_sig_dimu_mass[ptbin][sysbin].Fill( dimu_mass, weight );
 h_sig_diele_mass[ptbin][sysbin].Fill( diele_mass, weight );
...
Bool_t postAnalyzer_znunug::WriteHistograms(int ptbin, int sysbin){
 ...
 h_sig_leptoMET[ptbin][sysbin].Write();  
 h_sig_dilep_mass[ptbin][sysbin].Write();
 h_sig_dimu_mass[ptbin][sysbin].Write(); 
 h_sig_diele_mass[ptbin][sysbin].Write();
