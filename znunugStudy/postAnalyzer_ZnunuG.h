...
//        h_sig_pfMET[7][0],
//        h_sig_leptoMET[7][0],
//        h_sig_dilep_mass[7][0];
//
//   std::vector<int> phoCand[0]; // nr. of systematics
   ...
   std::vector<int> phoCand; // nr. of systematics
...
//     // set up names
     ...
     //h_sig_dimu_mass[i] = TH1F(histname_sig_dimu_mass,"PF MET + dimuon",30,60.,120.);
     //h_sig_dimu_mass[i].Sumw2();
     ////
     //h_sig_diele_mass[i].Clear();
     //h_sig_diele_mass[i] = TH1F(histname_sig_diele_mass,"PF MET + diele",30,60.,120.);
...
// h_sig_dimu_mass[ptbin].Fill( dimu_mass, weight );
// h_sig_diele_mass[ptbin].Fill( diele_mass, weight );
