...
#ifndef postAnalyzer_Signal_h
#define postAnalyzer_Signal_h
...
public :
   ...
   postAnalyzer_Signal(TTree *tree=0);
   virtual ~postAnalyzer_Signal();
...
#ifdef postAnalyzer_Signal_cxx
postAnalyzer_Signal::postAnalyzer_Signal(TTree *tree) : fChain(0) 
{
}

postAnalyzer_Signal::~postAnalyzer_Signal()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t postAnalyzer_Signal::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t postAnalyzer_Signal::LoadTree(Long64_t entry)
{
...
void postAnalyzer_Signal::Init(TTree *tree, Bool_t isMC)
{
...
Bool_t postAnalyzer_Signal::Notify()
{
...
void postAnalyzer_Signal::Show(Long64_t entry)
{
...
Int_t postAnalyzer_Signal::Cut(Long64_t entry)
{
...
//Bool_t postAnalyzer_Signal::FillGenHistograms(int ptbin, int sysbin, int photonIndex, double weight){
// weight = 1;
...
#endif // #ifdef postAnalyzer_Signal_cxx
